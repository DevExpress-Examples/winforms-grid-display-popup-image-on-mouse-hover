...
Namespace WindowsFormsApplication85
	...
	End Class
End Namespace
Namespace WindowsFormsApplication85.nwindDataSetTableAdapters
	...
	Partial Public Class TableAdapterManager
		...
		Public Property CategoriesTableAdapter() As CategoriesTableAdapter
			...
			Set(ByVal value As CategoriesTableAdapter)
				If ((Me._categoriesTableAdapter IsNot Nothing) AndAlso (Me.TableAdapterInstanceCount = 1)) Then
					Me._categoriesTableAdapter = value
					Return
				End If
				If ((value IsNot Nothing) AndAlso (Me.MatchTableAdapterConnection(value.Connection) = False)) Then
		...
		Public Overridable Function UpdateAll(ByVal dataSet As nwindDataSet) As Integer
			...
			If ((workConnection.State And Global.System.Data.ConnectionState.Closed) = Global.System.Data.ConnectionState.Closed) Then
				workConnection.Open()
				workConnOpened = True
			End If
